...
/// * [broadcast] 
@BuiltValue()
abstract class Erc721Request implements Built<Erc721Request, Erc721RequestBuilder> {
  ...
  factory Erc721Request([void updates(Erc721RequestBuilder b)]) = _$Erc721Request;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(Erc721RequestBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<Erc721Request> get serializer => _$Erc721RequestSerializer();
}

class _$Erc721RequestSerializer implements PrimitiveSerializer<Erc721Request> {
  @override
  final Iterable<Type> types = const [Erc721Request, _$Erc721Request];

  @override
  final String wireName = r'Erc721Request';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    Erc721Request object, {
  ...
  void _deserializeProperties(
    ...
    required Erc721RequestBuilder result,
  ...
  @override
  Erc721Request deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = Erc721RequestBuilder();
