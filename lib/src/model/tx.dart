...
abstract class Tx implements Built<Tx, TxBuilder> {
  ...
  factory Tx([void updates(TxBuilder b)]) = _$Tx;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(TxBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<Tx> get serializer => _$TxSerializer();
}

class _$TxSerializer implements PrimitiveSerializer<Tx> {
  @override
  final Iterable<Type> types = const [Tx, _$Tx];

  @override
  final String wireName = r'Tx';
