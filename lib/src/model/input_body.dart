...
/// * [broadcast] 
@BuiltValue()
abstract class InputBody implements Built<InputBody, InputBodyBuilder> {
  ...
  factory InputBody([void updates(InputBodyBuilder b)]) = _$InputBody;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(InputBodyBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<InputBody> get serializer => _$InputBodySerializer();
}

class _$InputBodySerializer implements PrimitiveSerializer<InputBody> {
  @override
  final Iterable<Type> types = const [InputBody, _$InputBody];

  @override
  final String wireName = r'InputBody';
  ...
  void _deserializeProperties(
    ...
    required InputBodyBuilder result,
  ...
  @override
  InputBody deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = InputBodyBuilder();
