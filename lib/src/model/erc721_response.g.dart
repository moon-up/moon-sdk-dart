...
part of 'erc721_response.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$Erc721Response extends Erc721Response {
  @override
  final double? type;
  @override
  ...
  @override
  final String? isApprovedForAll;

  factory _$Erc721Response([void Function(Erc721ResponseBuilder)? updates]) =>
      (new Erc721ResponseBuilder()..update(updates))._build();
  ...
  @override
  Erc721Response rebuild(void Function(Erc721ResponseBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  Erc721ResponseBuilder toBuilder() =>
      new Erc721ResponseBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is Erc721Response &&
        type == other.type &&
        ...
        isApprovedForAll == other.isApprovedForAll;
  }
  ...
  int get hashCode {
    ...
    _$hash = $jc(_$hash, ownerOf.hashCode);
    _$hash = $jc(_$hash, tokenUri.hashCode);
    _$hash = $jc(_$hash, contractAddress.hashCode);
    _$hash = $jc(_$hash, isApprovedForAll.hashCode);
    _$hash = $jf(_$hash);
    return _$hash;
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'Erc721Response')
          ..add('type', type)
          ..add('chainId', chainId)
          ..add('data', data)
          ..add('gas', gas)
          ...
          ..add('isApprovedForAll', isApprovedForAll))
        .toString();
  }
}

class Erc721ResponseBuilder
    implements Builder<Erc721Response, Erc721ResponseBuilder> {
  _$Erc721Response? _$v;
  ...
  String? _ownerOf;
  String? get ownerOf => _$this._ownerOf;
  set ownerOf(String? ownerOf) => _$this._ownerOf = ownerOf;
  ...
  String? _isApprovedForAll;
  String? get isApprovedForAll => _$this._isApprovedForAll;
  set isApprovedForAll(String? isApprovedForAll) =>
      _$this._isApprovedForAll = isApprovedForAll;

  Erc721ResponseBuilder() {
    Erc721Response._defaults(this);
  }

  Erc721ResponseBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _type = $v.type;
      _chainId = $v.chainId;
      ...
      _isApprovedForAll = $v.isApprovedForAll;
      _$v = null;
    }
    return this;
  }
  ...
  @override
  void replace(Erc721Response other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$Erc721Response;
  }

  @override
  void update(void Function(Erc721ResponseBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  Erc721Response build() => _build();

  _$Erc721Response _build() {
    _$Erc721Response _$result;
    try {
      _$result = _$v ??
          new _$Erc721Response._(
              type: type,
              chainId: chainId,
              data: data,
              gas: gas,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'Erc721Response', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
