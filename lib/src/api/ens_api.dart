...
class ENSApi {
  ...
  const ENSApi(this._dio, this._serializers);
  ...
  Future<Response<AccountControllerResponse>> resolve({ 
    ...
    try {
      const _type = FullType(EnsResolveInput);
      _bodyData = _serializers.serialize(ensResolveInput, specifiedType: _type);
