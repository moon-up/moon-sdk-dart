...
class LitecoinApi {
  ...
  const LitecoinApi(this._dio, this._serializers);
  ...
  Future<Response<AccountControllerResponse>> createLitecoinAccount({ 
    ...
    try {
      const _type = FullType(LitecoinInput);
      _bodyData = _serializers.serialize(litecoinInput, specifiedType: _type);
  ...
  Future<Response<AccountControllerResponse>> getLitecoinAccount({ 
    ...
    final _path = r'/litecoin/{accountName}'.replaceAll('{' r'accountName' '}', encodeQueryParameter(_serializers, accountName, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        r'Authorization': authorization,
  ...
  Future<Response<AccountControllerResponse>> signLitecoinTransaction({ 
    ...
    final _path = r'/litecoin/{accountName}/sign-tx'.replaceAll('{' r'accountName' '}', encodeQueryParameter(_serializers, accountName, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        r'Authorization': authorization,
    ...
    try {
      const _type = FullType(LitecoinTransactionInput);
      _bodyData = _serializers.serialize(litecoinTransactionInput, specifiedType: _type);
