...
class EosApi {
  ...
  const EosApi(this._dio, this._serializers);
  ...
  Future<Response<AccountControllerResponse>> createEosAccount({ 
    ...
    try {
      const _type = FullType(EosInput);
      _bodyData = _serializers.serialize(eosInput, specifiedType: _type);
  ...
  Future<Response<AccountControllerResponse>> getEosAccount({ 
    ...
    final _path = r'/eos/{accountName}'.replaceAll('{' r'accountName' '}', encodeQueryParameter(_serializers, accountName, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        r'Authorization': authorization,
  ...
  Future<Response<AccountControllerResponse>> signEosTransaction({ 
    ...
    final _path = r'/eos/{accountName}/sign-tx'.replaceAll('{' r'accountName' '}', encodeQueryParameter(_serializers, accountName, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        r'Authorization': authorization,
    ...
    try {
      const _type = FullType(EosTransactionInput);
      _bodyData = _serializers.serialize(eosTransactionInput, specifiedType: _type);
