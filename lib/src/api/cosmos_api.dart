...
import 'package:moonsdk/src/model/cosmos_api_response.dart';
...
class CosmosApi {
  ...
  const CosmosApi(this._dio, this._serializers);
  ...
  Future<Response<AccountAPIResponse>> createCosmosAccount({ 
    ...
    try {
      const _type = FullType(CosmosInput);
      _bodyData = _serializers.serialize(cosmosInput, specifiedType: _type);
  ...
  Future<Response<AccountAPIResponse>> getCosmosAccount({ 
    ...
    final _path = r'/cosmos/{accountName}'.replaceAll('{' r'accountName' '}', encodeQueryParameter(_serializers, accountName, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        r'Authorization': authorization,
  ...
  Future<Response<CosmosAPIResponse>> signCosmosTransaction({ 
    ...
    final _path = r'/cosmos/{accountName}/sign-tx'.replaceAll('{' r'accountName' '}', encodeQueryParameter(_serializers, accountName, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        r'Authorization': authorization,
    ...
    try {
      const _type = FullType(CosmosTransactionInput);
      _bodyData = _serializers.serialize(cosmosTransactionInput, specifiedType: _type);
