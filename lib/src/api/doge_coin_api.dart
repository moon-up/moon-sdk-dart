...
class DogeCoinApi {
  ...
  const DogeCoinApi(this._dio, this._serializers);
  ...
  Future<Response<AccountControllerResponse>> createDogeCoinAccount({ 
    ...
    try {
      const _type = FullType(DogeCoinInput);
      _bodyData = _serializers.serialize(dogeCoinInput, specifiedType: _type);
  ...
  Future<Response<AccountControllerResponse>> getDogeCoinAccount({ 
    ...
    final _path = r'/dogecoin/{accountName}'.replaceAll('{' r'accountName' '}', encodeQueryParameter(_serializers, accountName, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        r'Authorization': authorization,
  ...
  Future<Response<AccountControllerResponse>> signDogeCoinTransaction({ 
    ...
    final _path = r'/dogecoin/{accountName}/sign-tx'.replaceAll('{' r'accountName' '}', encodeQueryParameter(_serializers, accountName, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        r'Authorization': authorization,
    ...
    try {
      const _type = FullType(DogeCoinTransactionInput);
      _bodyData = _serializers.serialize(dogeCoinTransactionInput, specifiedType: _type);
