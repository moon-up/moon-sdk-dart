...
class AaveApi {
  ...
  const AaveApi(this._dio, this._serializers);
  ...
  Future<Response<TransactionAPIResponse>> borrow({ 
    ...
    final _path = r'/aave/{name}/borrow'.replaceAll('{' r'name' '}', encodeQueryParameter(_serializers, name, const FullType(String)).toString());
    ...
    try {
      const _type = FullType(AaveInput);
      _bodyData = _serializers.serialize(aaveInput, specifiedType: _type);
  ...
  Future<Response<TransactionAPIResponse>> lend({ 
    ...
    final _path = r'/aave/{name}/lend'.replaceAll('{' r'name' '}', encodeQueryParameter(_serializers, name, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        r'Authorization': authorization,
  ...
  Future<Response<TransactionAPIResponse>> repay({ 
    ...
    final _path = r'/aave/{name}/repay'.replaceAll('{' r'name' '}', encodeQueryParameter(_serializers, name, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        r'Authorization': authorization,
  ...
  Future<Response<AaveReservesAPIResponse>> userReserveData({ 
    ...
    final _path = r'/aave/{name}/user-reserve-data'.replaceAll('{' r'name' '}', encodeQueryParameter(_serializers, name, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        r'Authorization': authorization,
