...
class Erc4337Api {
  ...
  const Erc4337Api(this._dio, this._serializers);
  ...
  Future<Response<AccountControllerResponse>> getAddress({ 
    ...
    final _path = r'/erc4337/{accountName}/address'.replaceAll('{' r'accountName' '}', encodeQueryParameter(_serializers, accountName, const FullType(String)).toString());
  ...
  Future<Response<AccountControllerResponse>> signBroadcastUserOpTx({ 
    ...
    final _path = r'/erc4337/{accountName}/sign-broadcast-userop-tx'.replaceAll('{' r'accountName' '}', encodeQueryParameter(_serializers, accountName, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        r'Authorization': authorization,
