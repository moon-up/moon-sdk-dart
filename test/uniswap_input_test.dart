...
// tests for UniswapInput
void main() {
  final instance = UniswapInputBuilder();
  ...
  group(UniswapInput, () {
    ...
    // String tokenA
    test('to test the property `tokenA`', () async {
      // TODO
    });

    // String tokenB
    test('to test the property `tokenB`', () async {
      // TODO
    });

    // String amountA
    test('to test the property `amountA`', () async {
      // TODO
    });

    // String amountB
    test('to test the property `amountB`', () async {
      // TODO
    });
