...
// tests for INFTApproval
void main() {
  final instance = INFTApprovalBuilder();
  ...
  group(INFTApproval, () {
    ...
    // String tokenContractType
    test('to test the property `tokenContractType`', () async {
      // TODO
    });
    ...
    // bool approvedAll
    test('to test the property `approvedAll`', () async {
      // TODO
    });
